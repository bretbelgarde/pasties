...
<body>
  ...
  <main id="pasties-container">
    <div class="pasties-list">
      <?php echo $this->render('../templates/partials/pasties-sidebar.html',$this->mime,get_defined_vars(),0); ?>
    </div>
    <div class="pasties-display">
      <?php echo $this->render('../templates/partials/pasties-display.html',$this->mime,get_defined_vars(),0); ?>
    </div>
